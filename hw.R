...
gratefulDead <- get_artist_audio_features('grateful dead')
ggplot(gratefulDead, aes(x = tempo, y = energy, size = valence, color = album_name)) + geom_point() + ggtitle("Tame Impala Analysis")
